...
Example:
python map_land_da_v1p1_input_data.py -b land-da -k current_land_da_release_data/v1.1.0/landda-input-data-2016.tar.gz
python map_land_da_v1p1_input_data.py -b land-da -k current_land_da_release_data/v1.1.0/landda-input-data-2020.tar.gz
...
argParser.add_argument("-k", "--key", help="TAR-based object's key. Type: String. Ex: 'current_land_da_release_data/v1.1.0/landda-input-data-2016.tar.gz' ")
...
df = wrapper.extract_first_res(df, 'Data File', 'Sub-Category 3')

# Ocean resolution (mx) extracted w/ priority & secondary "ocean resolution" feature column set.
df = wrapper.extract_mx_res(df, 'Data File', 'Sub-Category 3')
