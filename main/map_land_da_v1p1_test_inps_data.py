...
Example:
python map_land_da_v1p1_test_inps_data.py -b land-da -k current_land_da_release_data/v1.1.0/landda-test-inps.tar.gz
...
argParser.add_argument("-k", "--key", help="TAR-based object's key. Type: String. Ex: 'current_land_da_release_data/v1.1.0/landda-test-inps.tar.gz' ")
