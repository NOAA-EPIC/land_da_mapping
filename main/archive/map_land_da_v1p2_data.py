...
# Data version extracted w/ priority & secondary "version" feature column set.
df = wrapper.extract_version(df, 10, 'Sub-Category 2')
...
df.insert(7, "Data Format", df.pop("Data Format"))
df.insert(8, "File Size (Bytes)", df.pop("File Size (Bytes)"))
df.insert(9, "Version", df.pop("Version"))
df.insert(10, "Dataset Type", df.pop("Dataset Type"))
