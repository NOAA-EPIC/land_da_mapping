...
Example:
python map_land_da_develop_data.py -b land-da -k develop/Landda_develop_data.tar.gz
...
argParser.add_argument("-k", "--key", help="TAR-based object's key. Type: String. Ex: 'develop/Landda_develop_data.tar.gz' ")
...
if not os.path.exists(f'../results/develop'):
    os.makedirs(f'../results/develop')
sys.path.append( f'../results/develop' )
