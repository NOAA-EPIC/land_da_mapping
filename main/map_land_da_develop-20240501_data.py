...
Example:
python map_land_da_develop-20240501_data.py -b land-da -k develop-20240501/Landda_develop_data.tar.gz
...
argParser.add_argument("-k", "--key", help="TAR-based object's key. Type: String. Ex: 'develop-20240501/Landda_develop_data.tar.gz' ")
...
df.insert(10, "Sub-Category 4", df.pop("Sub-Category 4"))

# Save data details.
# Create folder directory to save data maps & list of cloud keys.
if not os.path.exists(f'../results/develop-20240501'):
    os.makedirs(f'../results/develop-20240501')
sys.path.append( f'../results/develop-20240501')
