...
Example:
python map_land_da_v1p0p0_baseline_data.py -b land-da -k current_land_da_release_data/v1.0.0/landda-baseline-data-2016.tar.gz
python map_land_da_v1p0p0_baseline_data.py -b land-da -k current_land_da_release_data/v1.0.0/landda-baseline-data-2020.tar.gz
...
argParser.add_argument("-k", "--key", help="TAR-based object's key. Type: String. Ex: 'current_land_da_release_data/v1.0.0/landda-baseline-data-2016.tar.gz' ")
...
df = wrapper.extract_first_res(df, 'Data File', 'Sub-Category 4')

# Ocean resolution (mx) extracted w/ priority & secondary "ocean resolution" feature column set.
df = wrapper.extract_mx_res(df, 'Data File', 'Sub-Category 4')
...
df.insert(5, "Sub-Category 4", df.pop("Sub-Category 4"))
df.insert(6, "Resolution (C)", df.pop("Resolution (C)"))
df.insert(7, "Ocean Resolution (mx)", df.pop("Ocean Resolution (mx)"))
df.insert(8, "File Extension", df.pop("File Extension"))
df.insert(9, "File Size (Bytes)", df.pop("File Size (Bytes)"))
